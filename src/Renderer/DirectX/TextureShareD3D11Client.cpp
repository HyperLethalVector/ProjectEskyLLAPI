...
bool FTextureShareD3D11Client::CreateShare(std::wstring ShareName)
{
	...
	return FTextureShareInterface::CreateTextureShare((wchar_t*)ShareName.c_str(), ETextureShareProcess::Client, DefaultSyncPolicy, ETextureShareDevice::D3D11);
}

bool FTextureShareD3D11Client::DeleteShare(std::wstring ShareName)
{
	return FTextureShareInterface::ReleaseTextureShare((wchar_t*)ShareName.c_str());
}

bool FTextureShareD3D11Client::BeginSession(std::wstring ShareName)
{
	return FTextureShareInterface::BeginSession((wchar_t*)ShareName.c_str());
}

bool FTextureShareD3D11Client::EndSession(std::wstring ShareName)
{
	return FTextureShareInterface::EndSession((wchar_t*)ShareName.c_str());
}

bool FTextureShareD3D11Client::BeginFrame_RenderThread(std::wstring ShareName)
{
	return FTextureShareInterface::BeginFrame_RenderThread((wchar_t*)ShareName.c_str());
}

bool FTextureShareD3D11Client::EndFrame_RenderThread(std::wstring ShareName)
{
	return FTextureShareInterface::EndFrame_RenderThread((wchar_t*)ShareName.c_str());
}

bool FTextureShareD3D11Client::IsRemoteTextureUsed(std::wstring ShareName, std::wstring TextureName)
{
	return FTextureShareInterface::IsRemoteTextureUsed((wchar_t*)ShareName.c_str(), (wchar_t*)TextureName.c_str());
}
...
bool FTextureShareD3D11Client::RegisterTexture(std::wstring ShareName, std::wstring TextureName, ETextureShareSurfaceOp TextureOp, uint32 Width, uint32 Height, DXGI_FORMAT InFormat)
{
	...
	return FTextureShareInterface::RegisterTexture((wchar_t*)ShareName.c_str(), (wchar_t*)TextureName.c_str(), Width, Height, ShareFormat, ShareFormatValue, TextureOp);
}
...
{
	return FTextureShareInterface::GetRemoteAdditionalData((wchar_t*)ShareName.c_str(), *OutFrameData);
}
...
bool FTextureShareD3D11Client::ReadTextureFrame_RenderThread(std::wstring ShareName, std::wstring TextureName, ID3D11Texture2D** InOutTexture, ID3D11ShaderResourceView** InOutTextureSRV)
{
	...
	if (FTextureShareInterface::IsValid((wchar_t*)ShareName.c_str()))
	{
		ID3D11Texture2D* SharedResource;
		if (FTextureShareInterface::LockTextureD3D11_RenderThread(pD3D11Device, (wchar_t*)ShareName.c_str(), (wchar_t*)TextureName.c_str(), SharedResource))
		{
			...
			FTextureShareInterface::UnlockTexture_RenderThread((wchar_t*)ShareName.c_str(), (wchar_t*)TextureName.c_str());
		}
		else
		{
